    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-[#F5F5F7] pt-16">
      ...
      >
        <motion.div variants={fadeInUp} className="text-center mb-16">
          <Shield className="w-16 h-16 text-[#22c55e] mx-auto mb-6" strokeWidth={1.5} />
        ...
        <motion.div variants={fadeInUp} className={`${glassCardClass} p-12 md:p-16`}>
          ...
          <p className="text-lg text-gray-600 mb-6 font-light leading-relaxed">
            We believe trust starts with clarity. Our legal documents explain how Nile Booking operates, how data is handled, and what users can expect from the platform.
          </p>
          <p className="text-lg text-gray-600 mb-6 font-light leading-relaxed">
            We collect only what is necessary to operate the platform and improve your experience.
          </p>
          <p className="text-lg text-gray-600 font-light leading-relaxed">
            Your data is never sold, misused, or accessed without reason. Privacy and security are core to how Nile Booking is built.
          </p>
        </motion.div>
